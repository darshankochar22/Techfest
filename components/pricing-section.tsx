  ...
  const pricingPlans = [
    {
      ...
      monthlyPrice: "$0",
      annualPrice: "$0",
      description: "Perfect for recruiters getting started.",
      features: [
        "Real-time interview insights",
        "Basic integration logos",
        "Single MCP server connection",
        "Up to 2 concurrent interview sessions",
        "Candidate reports with Pointer branding",
      ],
    ...
    },
    {
      ...
      features: [
        "Enhanced real-time interview analytics",
        "Unlimited integrations with custom logos",
        "Multiple MCP server connections",
        "Up to 10 concurrent interview sessions",
        "Collaborative hiring with team chat",
    ...
    },
    {
      ...
      features: [
        ...
        "Unlimited concurrent interview sessions",
      ...
      <div className="self-stretch relative flex flex-col justify-center items-center gap-2 py-0">
        <div className="flex flex-col justify-start items-center gap-4">
          <h2 className="text-center text-foreground text-4xl md:text-5xl font-semibold leading-tight md:leading-[40px]">
            Pricing built for every recruiter
          </h2>
          <p className="self-stretch text-center text-muted-foreground text-sm font-medium leading-tight">
            Choose a plan that fits your hiring workflow, from individual recruiters to <br /> growing teams
